<!--
  ...
  - 3D contribution calendar: regenerated by .github/workflows/profile-3d.yml into
    profile-3d-contrib/ on the main branch, daily. Embed a different preset by
    changing the filename at the end of its raw URL (profile-night-rainbow.svg is
    the neon one; others under profile-3d-contrib/).
  - Contribution snake: regenerated by .github/workflows/snake.yml into the
    "output" branch, every 12 hours.
